...
<body style="margin-top:50px;" style="margin-top:50px;">
  ...
  <div style="position: relative;">
    <img src="image/country/zanzibar01.jpg" alt="Serengeti" style="width: 100%; max-height: 300px; object-fit: cover;">
    <div style="position: absolute; bottom: 0; left: 0; padding: 20px;  color: white;">
      <h2>Vacation to Zanzibar</h2>
...
<div class="container text-center">   
 	...
 	<?php 
	$sql=mysqli_query($con,"select * from tour_packages where location ='Zanzibar'");
?><h1 style="text-align:left"> <font color="#000000;"><b>Zanzibar</b></font></h1><br> 
<div class="row">
  <div class="col-sm-12">
    <div class="my_card p-3 mb-3 border bg-secondary">
      
        <h4 class="text-left"><b><font color="#000000;">Top Zanzibar Tour Package</b></h4></font>
        
      
      <p class="text-justify"><font color="#000000;">Unguja, also known as Zanzibar Island, is the main island in the Tanzanian archipelago of Zanzibar. Stone Town, part of Zanzibar City, is an old trade center, with mosques and winding lanes. The 1883 House of Wonders is a former sultan’s palace with a clock tower. The Old Fort now houses a cultural center and a stone amphitheater. </font></p>
...
<h4 class="text-left"><b><font color="#000000;">Zanzibar  Deals</b></h4></font>
